...
void nrf24l01p_set_rx_address(uint8_t* addr)
{
    uint8_t cmd = NRF24L01P_CMD_W_REGISTER | NRF24L01P_REG_RX_ADDR_P0;
    cs_low();
    HAL_SPI_Transmit(NRF24L01P_SPI, &cmd, 1, 1000);
    HAL_SPI_Transmit(NRF24L01P_SPI, addr, 5, 1000);
    cs_high();
}

void nrf24l01p_set_tx_address(uint8_t* addr)
{
